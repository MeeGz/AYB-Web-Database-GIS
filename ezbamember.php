...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <a href="showsuperiorezbamember.php" class="btn btn-lg btn-primary">Show Superior Ezba Members' Details</a>
        </div> <br
		<div class="row">
            <a href="showinferiorezbamember.php" class="btn btn-lg btn-primary">Show Inferior  Members' Details</a>
        </div> <br>
        <div class="row">
