...
if (isset($_POST['name'])) {
    ...
    $sql = "UPDATE ezbamember SET name='".$m->name."',phone='".$m->phone."',email='".$m->email."',university='".$m->university."',faculty='".$m->faculty."',studyYear='".$m->studyYear."',residence='".$m->residence."',AYBYear='".$m->AYBYear."' WHERE AYBMemberID=".$_POST['id'];
    echo $sql;
